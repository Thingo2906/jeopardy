...
function fillTable(categories) {
     ...
     categories.forEach((category, idx) => {
        ...
        if (idx < 5){
          $tbody.append(buildClueSquares(categories, idx));
        }
     });
 ...
 * */
 ...
 function handleClick(evt) {
    ...
    else if (evt.currentTarget.firstElementChild.nextElementSibling.classList.contains('showing')) {
        evt.currentTarget.classList.add('flipped','answered');
...
$('#gameboard').on('click', '.game-square', handleClick);
